...
contract ComputerMarketplace {  
    ...
    function writeProduct(
        ...
        require(productsByUser[msg.sender] < maxProductsPerUser, "Maximum products per user reached");
    ...
    require(products[_index].owner == msg.sender, "Only the product owner can delete it.");

    // delete the product by shifting all elements above the deleted one down by one index
